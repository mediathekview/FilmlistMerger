...
public enum Metrics {
    ...
    COUNTER_INVALID_FILMS(Types.METRIC_TYPE_COUNTER,"filmlistmerger.films.invalid?increment=1&tags=app=filmlistmerger"),
    SUMMARY_MERGED_FILMS_WRITE(Types.METRIC_TYPE_SUMMARY,"filmlistmerger.films.write.merged.summary?tags=app=filmlistmerger"),
