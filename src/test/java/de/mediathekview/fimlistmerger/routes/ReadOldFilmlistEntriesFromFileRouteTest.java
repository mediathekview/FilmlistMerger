...
class ReadOldFilmlistEntriesFromFileRouteTest {
    ...
    @Test
    void file_with_old_filmlist_entries_all_entries_read_as_single_messages() throws InterruptedException {
        // given
        ...
        assertThat(receivedEntries)
                ...
                .containsExactly(
                        ...
                        new String[]{"ARD", "TestThema2", "TestTitel", "01.01.2018", "23:54:00", "00:10:00", "2",
                                "Test beschreibung.", "http://example.org/Test.mp4", "http://www.example.org/", "", "",
                                "19|klein.mp4", "", "19|hd.mp4", "", "1514847240", "", "", "false"},
                        new String[]{"BR", "TestThema2", "TestTitel", "01.01.2017", "23:55:00", "00:10:00", "2",
                                "Test beschreibung.", "http://example.org/Test.mp4", "http://www.example.org/", "", "",
                                "19|klein.mp4", "", "19|hd.mp4", "", "1483311300", "", "", "false"}
                );
    }
